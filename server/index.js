...
app.post('/payments', (req, res) => {
  ...
  console.log(`You retried the same id`+JSON.stringify(payment));
  console.log(`You Users`+JSON.stringify(Users));
  if (!_.isString(payment.id)) {
    return res.status(400).json({ error: `Incorrectly formatted id '${_.isString(payment.id)}'`});
  }
